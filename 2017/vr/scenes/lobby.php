...
<a-scene id="lobby-scene" class="scene">
    ...
    <a-sky src="assets/img/scene-backgrounds/lobby.jpg"></a-sky>
    ...
    <!-- CREATE A SPHERE -->
    <a-sphere class="navpoint" nextscene="lobby2" src="assets/img/earthmap1k.jpg" class="collidable" radius="3" position="11.3 -4 15">
        <!-- ANIMATE THE BOX 360 DEGREES ON CLICK -->
        <a-animation attribute="rotation" begin="click" to="0 360 0"></a-animation>
        </a-box>
</a-scene>
